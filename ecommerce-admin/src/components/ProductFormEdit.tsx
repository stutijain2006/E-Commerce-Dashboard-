...
export default function ProductFormEdit({ product }: ProductFormEditProps) {
    ...
    const onSubmit = async (data: ProductFormData) => {
        ...
        try {
            ...
            setSuccessMessage(`Product ${isEditMode ? 'updated' : 'added'} successfully! Redirecting...`);
                ...
                <div className="space-y-2">
                    ...
                    {imageUrl && !imageError && (
                        <div className="mt-3 p-4 bg-green-50 border border-green-200 rounded-lg">
                            <p className="text-green-700 text-sm font-semibold mb-3">✓ Image {isEditMode ? 'updated' : 'uploaded'} successfully</p>
                            <img
                                src={imageUrl}
                                alt="Preview"
